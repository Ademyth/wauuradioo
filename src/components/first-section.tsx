...
// import { PhoneAndroid, PlayArrow } from "@material-ui/icons";
...
//           size="large"
//           color="primary"
//           endIcon={<PlayArrow className={classes.buttonIcon} />}
//           className={classes.button}
//           onClick={() => {
//             window.location.assign("#section-2");
//           }}
...
function FirstSection() {
  ...
  const audioRef = React.useRef(new Audio("https://fdsfdsfdsf.radio12345.com/intro.mp3"));
